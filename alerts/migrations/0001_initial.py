...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'ordering': ('-created_at',),
                'indexes': [models.Index(fields=['acknowledged', 'severity'], name='alerts_aler_acknowl_582057_idx'), models.Index(fields=['created_at'], name='alerts_aler_created_8af5ce_idx')],
            },
        ),
    ]
