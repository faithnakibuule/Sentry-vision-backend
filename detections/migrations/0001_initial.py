...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['zone', 'timestamp'], name='detections__zone_0f09a0_idx'),
        ),
        migrations.AddIndex(
            model_name='detectionevent',
            index=models.Index(fields=['device', 'timestamp'], name='detections__device__2890bf_idx'),
        ),
    ]
